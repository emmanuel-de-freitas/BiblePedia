 ...
 */
export const isProduction = (env: { NODE_ENV?: string }): boolean => env.NODE_ENV === "production";

export const isDevelopment = (env: { NODE_ENV?: string }): boolean =>
	env.NODE_ENV === "development";

export const isTest = (env: { NODE_ENV?: string }): boolean => env.NODE_ENV === "test";

export const isStaging = (env: { NODE_ENV?: string }): boolean => env.NODE_ENV === "staging";
