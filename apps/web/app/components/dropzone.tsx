...
const Image = ({ src, alt, className, width, height, fill }: { src: string, alt: string, className?: string, width?: number, height?: number, fill?: boolean }) => (
  <img src={src} alt={alt} className={className} width={width} height={height} style={fill ? { position: 'absolute', height: '100%', width: '100%', left: 0, top: 0, right: 0, bottom: 0, objectFit: 'cover' } : undefined} />
);
