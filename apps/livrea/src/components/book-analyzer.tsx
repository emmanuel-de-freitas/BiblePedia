...
import { type BookMetadata, pythonAPI, type TextStatistics } from "@/api/python";
...
export function BookAnalyzer() {
	...
	return (
		<div className="max-w-5xl p-8">
			<h1 className="text-3xl font-bold mb-2">Book Analyzer - Python Integration Demo</h1>
			...
			<section className="mb-12">
				...
				<div className="flex gap-2 mb-4">
					<Button variant="primary" onPress={analyzeText} isDisabled={isAnalyzing}>
					...
					<div className="grid gap-4 mt-8">
						...
						<Card className="p-4">
							...
							<div className="space-y-1">
								...
								<p>Average Word Length: {statistics.basic_stats.average_word_length}</p>
							</div>
						</Card>
						...
						<Card className="p-4 bg-primary-50">
							...
							<div className="space-y-1">
								<p>
									Average Words per Sentence: {statistics.readability.average_words_per_sentence}
								</p>
								<p>
									Average Syllables per Word: {statistics.readability.average_syllables_per_word}
								</p>
								<p>Flesch Reading Ease: {statistics.readability.flesch_reading_ease}</p>
								<p>Difficulty Level: {statistics.readability.difficulty_level}</p>
							</div>
						</Card>
