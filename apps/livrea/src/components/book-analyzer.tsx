...
import { Button, Heading, ProgressBar, Text, TextArea } from "@react-spectrum/s2";
...
export function BookAnalyzer() {
   ...
   const analyzeText = async () => {
      ...
      try {
         ...
         console.log("Analysis complete:", { keywords: extractedKeywords, stats });
      } catch (err) {
   ...
   return (
      <div style={{ maxWidth: "1200px", padding: "32px" }}>
         ...
         <div style={{ marginTop: "16px" }}>
            <Text>This component demonstrates calling Python functions from React using tauri-plugin-python.</Text>
         </div>
            ...
            {statistics && (
               <div style={{ display: "flex", flexDirection: "column", gap: "16px", marginTop: "32px" }}>
                  ...
                  <div style={{ backgroundColor: "#d1fae5", borderRadius: "8px", padding: "16px" }}>
                     ...
                     <Text>
                        Estimated Time: {statistics.reading_time.minutes} minutes {statistics.reading_time.seconds}{" "}
                        seconds
                     </Text>
         ...
         <div style={{ marginTop: "48px" }}>
            ...
            {bookMetadata && (
               <div style={{ backgroundColor: "#e9d5ff", borderRadius: "8px", marginTop: "32px", padding: "16px" }}>
         ...
         {/* Error Display */}
         {error && (
            <div style={{ backgroundColor: "#fee2e2", borderRadius: "8px", marginTop: "16px", padding: "16px" }}>
               <Text>{error}</Text>
            </div>
         )}
      </div>
