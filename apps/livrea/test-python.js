...
async function testPythonIntegration() {
  ...
  try {
    ...
    const keywordText = "Python programming is great for data science and machine learning. Python makes coding easy and fun.";
    ...
    const metadata = {
      ...
      description: "A classic American novel about racial injustice and childhood innocence in the Deep South."
    };
